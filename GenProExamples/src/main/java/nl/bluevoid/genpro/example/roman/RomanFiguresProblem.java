...
public class RomanFiguresProblem extends TrainerVisual {
  ...
  public Setup createSetup() {
    ...
    consts.add(new ConstantCell("constA", Integer.class, 1));
    consts.add(new ConstantCell("constB", Integer.class, 5));
    consts.add(new ConstantCell("constC", Integer.class, 10));
//    consts.add(new ConstantCell("constD", Integer.class, 0, 50));
//    consts.add(new ConstantCell("constE", Integer.class, 0, 100));
